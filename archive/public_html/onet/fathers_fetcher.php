...
$filepath = __DIR__ . '/../../../../public_html/fathers/' . $filename;
...
// For fathers folder, all files appear to be in English with Windows-1252 encoding
// based on the content analysis

// List of files that definitely contain Cyrillic or special characters (if any are discovered)
$cyrillicFiles = array(
