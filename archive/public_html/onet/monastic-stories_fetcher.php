<?php
// Monastic Stories fetcher - based on prototype_fetcher.php
...
// Path to monastic-stories folder
$filepath = __DIR__ . '/../../../../public_html/monastic-stories/' . $filename;
...
// For monastic-stories folder, content is typically in English
