...
$filepath = __DIR__ . '/../../../../public_html/music/' . $filename;
...
// For music folder, we need to handle various encodings
// Music folder probably won't have many Cyrillic files
...
$cyrillicFiles = array(
    // Add any music files with Cyrillic content here if needed
);
