...
$filepath = __DIR__ . '/../../../../public_html/saints/' . $filename;
...
// For saints folder, we need to handle various encodings
// Saints folder contains mixed content - saint names in various languages
...
$cyrillicFiles = array(
    'john-the-romanian.html',
    'new-martyr-evgeny.html',
    // Add other files with Cyrillic content as needed
);
