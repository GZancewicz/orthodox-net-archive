...
$filepath = __DIR__ . '/../../../../public_html/theophany/' . $filename;
...
// For theophany folder, files are mostly English with some Greek
...
$cyrillicFiles = array(
    // No known Cyrillic files in theophany folder
);
